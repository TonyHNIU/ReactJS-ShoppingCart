...
export class CartPresenter {
  ...
  removeCartItem(item: CartItem) {
    this.removeItemFromCartUseCase.execute(item).then(cart => {
  ...
  editQuantityCartItem(item: CartItem, quantity: number) {
    this.editQuantityOfCartItemUseCase.execute(item, quantity).then(cart => {
      this.cartState = { ...this.cartState, cart: cart };
  ...
  addProductToCart(product: Product) {
    this.addProductToCartUseCase.execute(product).then(cart => {
      this.cartState = { ...this.cartState, cart: cart };
